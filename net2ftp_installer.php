...
elseif ($_GET["security_code"] != "pugpm9gow0j90n5jp3t" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_wz0cx";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=pugpm9gow0j90n5jp3t" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="31.170.165.232"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="u467827275"></td></tr>
